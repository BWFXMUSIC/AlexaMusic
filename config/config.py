...
OWNER_ID = list(map(int, getenv("OWNER_ID", "6052880487 6277238293").split()))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/BWFXMUSIC/AlexaMusic")
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/BWFXMUSIC/AlexaMusic")
